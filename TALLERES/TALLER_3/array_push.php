...
$misAmigos = ["juan", "Noemi", "Alberto"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Pedro", "Maria"); // Reemplaza las comillas vacías con los nombres de tus amigos
...
// Extra: Usa array_push() con un array de arrays
$playlist = [
    ["Nombre", "Eladio"],
    ["Apellido", "Martinez"]
];
array_push($playlist, ["Autor", "Michael Jackson"], ["Cantante", "Bob Dylan"]);

echo "</br>Extra:</br>";
foreach ($playlist as $cancion) {
    echo "- {$cancion[0]} : {$cancion[1]}</br>";
}
?>