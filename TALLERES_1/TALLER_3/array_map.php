...
$productos = [
    ...
    ["Apellido" => "Perro", "precio" => 300],
    ["Apellido" => "Gato", "precio" => 200],
    ["Apellido" => "Vaca", "precio" => 1500]
];
...
// añadido como apellido
echo "</br>Productos con descuento con apellido:</br>";
foreach ($productosConDescuento as $producto) {
    echo "- {$producto['Apellido']}: Precio original: ${$producto['precio']}, ";
    echo "Precio con descuento: ${$producto['precio_descuento']}</br>";
}
